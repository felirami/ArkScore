...
- `pnpm finalize:live:apply` publishes the live Railway/Fuji public values to Vercel, redeploys the submitted frontend, and retries strict live verification until the production deployment proves those values are present.
