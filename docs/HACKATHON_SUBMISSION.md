...
- The dashboard has an optional eERC20 card for the EncryptedERC privacy-preserving credit token demo; `pnpm probe:eerc20:strict` proves deployed Fuji bytecode when that address is part of the final pitch.
