...
- `pnpm readiness:strict:record` makes that `LatestScoreRecord.json` proof a required final-readiness gate before the Vercel handoff is sealed, including offline recomputation of the embedded score snapshot hash.
