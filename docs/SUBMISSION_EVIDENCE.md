...
Generated: 2026-05-17T01:08:38.577Z
...
```text
 ...
 M apps/api/src/config/env.test.ts
 M apps/api/src/config/env.ts
 M apps/api/src/openapi.ts
 M apps/api/src/routes/health.ts
 M apps/api/src/services/wavy-node.test.ts
 M apps/api/src/services/wavy-node.ts
 M docs/DEPLOYMENT.md
 M docs/HACKATHON_SUBMISSION.md
 M docs/READINESS_AUDIT.md
 M docs/REQUIREMENTS_TRACE.md
 M packages/contracts/scripts/record-live-score.ts
 M packages/shared/src/index.test.ts
 M packages/shared/src/index.ts
 M scripts/audit-requirements.ts
 M scripts/deploy-railway.ts
 M scripts/handoff-scripts.test.ts
 M scripts/judge-demo.ts
 M scripts/probe-wavy.ts
 M scripts/readiness-check.ts
 M scripts/submission-evidence.ts
...
ok 3 - openapi document honors Railway forwarded origin headers
  ---
  duration_ms: 3.632833
  type: 'test'
  ...
# Subtest: Wavy integration serves signed compliance user data
ok 4 - Wavy integration serves signed compliance user data
  ---
  duration_ms: 3.1645
  type: 'test'
  ...
# Subtest: Wavy integration receives signed webhook alerts
ok 5 - Wavy integration receives signed webhook alerts
  ---
  duration_ms: 13.461833
  type: 'test'
  ...
# Subtest: Wavy integration rejects invalid signatures
ok 6 - Wavy integration rejects invalid signatures
  ---
  duration_ms: 3.456167
  type: 'test'
  ...
# Subtest: score endpoint returns a Bankaool-ready mock Wavy response
ok 7 - score endpoint returns a Bankaool-ready mock Wavy response
  ---
  duration_ms: 3.856416
  type: 'test'
  ...
# Subtest: score endpoint rejects unsupported institutions
ok 8 - score endpoint rejects unsupported institutions
  ---
  duration_ms: 1.913416
  type: 'test'
  ...
# Subtest: score endpoint rate limits repeated clients
ok 9 - score endpoint rate limits repeated clients
  ---
  duration_ms: 9.662791
  type: 'test'
  ...
# Subtest: API config defaults Wavy Node scoring to Avalanche mainnet
ok 10 - API config defaults Wavy Node scoring to Avalanche mainnet
  ---
  duration_ms: 0.488708
  type: 'test'
  ...
# Subtest: API config keeps Wavy scoring chain separate from Fuji registry
ok 11 - API config keeps Wavy scoring chain separate from Fuji registry
  ---
  duration_ms: 0.130042
  type: 'test'
  ...
# Subtest: API config refuses unsupported Wavy Node chain IDs
ok 12 - API config refuses unsupported Wavy Node chain IDs
  ---
  duration_ms: 1.007208
  type: 'test'
  ...
1..12
# tests 12
...
ok 3 - fetchWavyRiskResult treats duplicate address registration as reusable
  ---
  duration_ms: 1.429583
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult creates an investigation when no scan result exists yet
ok 4 - fetchWavyRiskResult creates an investigation when no scan result exists yet
  ---
  duration_ms: 1.680375
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult reports failed Wavy investigations
ok 5 - fetchWavyRiskResult reports failed Wavy investigations
  ---
  duration_ms: 1.943583
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult rejects upstream chain mismatches
ok 6 - fetchWavyRiskResult rejects upstream chain mismatches
  ---
  duration_ms: 0.228666
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult rejects upstream address mismatches
ok 7 - fetchWavyRiskResult rejects upstream address mismatches
  ---
  duration_ms: 0.237917
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult preserves upstream Wavy Node errors
ok 8 - fetchWavyRiskResult preserves upstream Wavy Node errors
  ---
  duration_ms: 0.227792
  type: 'test'
  ...
# Subtest: fetchWavyRiskResult converts Wavy timeouts into a gateway timeout
ok 9 - fetchWavyRiskResult converts Wavy timeouts into a gateway timeout
  ---
...
# skipped 0
# todo 0
# duration_ms 212.449334

$ NODE_ENV=test WAVY_NODE_MOCK_MODE=true ARKSCORE_SUBJECT_HASH_SALT=arkscore-demo-subject-hash-salt ARKSCORE_SCORE_RATE_LIMIT_MAX=4 WAVY_NODE_INTEGRATION_SECRET=integration_test_secret WAVY_NODE_INTEGRATION_USER_DATA_JSON='{"givenName":"ArkScore","email":"compliance@example.com"}' tsx --test src/app.test.ts src/config/env.test.ts && NODE_ENV=test WAVY_NODE_MOCK_MODE=false WAVY_NODE_API_KEY=wavy_test_key WAVY_NODE_PROJECT_ID=project_test tsx --test src/services/wavy-node.test.ts && tsc --noEmit
...
[pass] Wavy Node traceability and AI risk score: adapter includes chains/register/investigation/scan-risk flow, Wavy Avalanche scoring config, Fuji registry separation, upstream result matching, and 0-100 traceability fields
...
[pass] Live Wavy credential proof: credentials and production subject-hash salt are configured
...
[pass] Wavy Node credentials: required for live Wavy Node source=wavy responses
[pass] Wavy Node chain ID: required so Wavy Node scores Avalanche mainnet while the oracle stores proof on Avalanche Fuji; source WAVY_NODE_CHAIN_ID
[pass] Subject hash salt: required to keep on-chain subject hashes environment-specific
